 ...
 * FlightReservationV1
 *
 * @ORM\Table(name="flight_reservation_v1", indexes={@ORM\Index(name="idx_f73df7ae6956883f", columns={"currency"})})
 * @ORM\Entity
 */
class FlightReservationV1
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="flight_reservation_v1_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
