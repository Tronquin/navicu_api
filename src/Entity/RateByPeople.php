 ...
 * RateByPeople
 *
 * @ORM\Table(name="rate_by_people", indexes={@ORM\Index(name="idx_cacc218254177093", columns={"room_id"}), @ORM\Index(name="idx_cacc218287414140", columns={"property_currency_id"})})
 * @ORM\Entity
 */
class RateByPeople
{
